...
int main(void){
	...
	// 20000000÷(65536×1) = 305 para saber a min escala(neste caso não existe esta escala então usamos os valores de 2 hz e fazemos a nossa ação a cada 2 interrupeções
